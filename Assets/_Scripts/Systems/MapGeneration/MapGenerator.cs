...
namespace Systems.MapGeneration
{
    public class MapGenerator : MonoBehaviour
    {
        ...
        private Dictionary<Vector2Int, Data.TileData> _tileDataGrid = new Dictionary<Vector2Int, Data.TileData>();
                ...
                for (int x = 0; x < _mapWidth; x++)
                {
                    ...
                    foreach (TerrainType terrainType in _terrainSet.terrainTypes)
                    {
                        if (currentHeight <= terrainType.height)
                        {
                            ...
                            _tileDataGrid[tilePosition2D] = new Data.TileData(Array.IndexOf(_terrainSet.terrainTypes, terrainType), false);
